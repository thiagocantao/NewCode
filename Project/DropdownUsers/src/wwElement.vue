<template>
  ...
  <div class="dropdown-wrapper" ref="wrapperRef">
    <UserSelector
      ...
      :show-assign-to-team="content.showAssignToTeam"
      :popup-horizontal-position="content.popupHorizontalPosition"
      :popup-vertical-position="content.popupVerticalPosition"
