...
{{ content.availableFieldsTitle || 'Available Fields' }}
</div>
...
<input type="text" value="Inserir texto" class="inputCabecalho"/>
</div>
<div class="status-header-display">
    <div class="status-tags">
      <span class="tag">Selecionar prioridade</span>
      <span class="tag">Categoria</span>
      <span class="tag">Subcategoria</span>
      <span class="tag">Categoria de terceiro nível</span>
    </div>

    <div class="status-user">
      <span class="user-info">
        <span class="user-icon"><i class="material-symbols-outlined">person</i></span>
        <span class="user-name">Não atribuído</span>
      </span>
      <span class="status-label">Novo</span>
    </div>
  </div>
</div>
...
gap: 5px;
max-height: calc(100vh - 290px); /* Ajuste conforme seu layout */
overflow-y: auto;
}
...
.form-sections-container {
max-height: calc(100vh - 340px); /* Ajuste conforme seu layout */
overflow-y: auto;
}
