...
setup(props, { emit }) {
      ...
      return sortedFields.map(field => {
        ...
        if (completeField) {
          return {
            ...
            tip_translations: field.tip_translations || completeField.tip_translations || { "pt-BR": field.tip || completeField.tip || '' }
          };
        }
    ...
    const updateSectionTitle = (event) => {
      ...
      if (newTitle && newTitle !== sectionTitle.value) {
        ...
        if (typeof props.section.title === 'object') {
          props.section.title.pt_br = newTitle;
        } else {
    ...
    const removeSection = () => {
      console.log('Removing section:', props.section);
          ...
          onAdd: (evt) => {
            ...
            if (fieldId && fieldData) {
              ...
              const newField = {
                ...
                tip_translations: fieldData.tip_translations || { "pt-BR": fieldData.tip || '' },
                deleted: false,
                name: fieldData.name,
